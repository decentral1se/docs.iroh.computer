...
**Relay connections.** Each device opens one or a  few long-lived encrypted connections to
...
1. An encrypted connection to the relay servers the application is configured
   with.
...
Dedicated relays from Iroh Services with authentication enabled do this for you, and only admit devices
...
every piece of infrastructure outside it with your own. This is the right answer
to most concerns about relays, third-party servers, and data residency.
