...
If the network is one you or your customer administers, and the problem looks
like blocked UDP, an HTTPS proxy, TLS interception, or DNS filtering, see
[Enterprise Networks](/deployment/enterprise-networks) for the full list of
flows to allow and how to configure iroh around each restriction.
